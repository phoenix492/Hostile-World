...
public class ModTagKeys {
    public static class Biomes {
        ...
        public static TagKey<Biome> MYCOFIRE_RESISTANT = createTag(HostileWorld.MODID,"mycofire_resistant");
    ...
    public static class Blocks {
        ...
        public static TagKey<Block> RED_FUNGUS = createTag(HostileWorld.MODID, "red_fungus");
        public static TagKey<Block> BROWN_FUNGUS = createTag(HostileWorld.MODID, "brown_fungus");
        ...
        public static TagKey<Block> BECOMES_MYCORESTONE = createTag(HostileWorld.MODID, "becomes_mycorestone");
        ...
        public static TagKey<Block> MYCOSTONES = createTag(HostileWorld.MODID, "mycostones");
        public static TagKey<Block> MYCOSTONE_BLOB_REPLACEABLES = createTag(HostileWorld.MODID, "mycostone_blob_replaceables");
