...
public class ModCreativeModeTabs {
    public static DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, HostileWorld.MODID);

    public static final Supplier<CreativeModeTab> HOSTILE_WORLD_CREATIVE_TAB = CREATIVE_MODE_TABS.register(
