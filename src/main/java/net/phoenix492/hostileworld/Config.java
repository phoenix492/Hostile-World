...
public class Config {
    ...
    public static final ModConfigSpec.IntValue FUNGAL_INFECTION_BIOME_BUILDUP = BUILDER
        .comment(" Amount of infection units per tick to build up on players in biomes tagged with hostileworld:builds_fungal_infection", " Default: 3")
    ...
    public static final ModConfigSpec.IntValue FUNGAL_INFECTION_DROPOFF = BUILDER
        .comment(" Amount of infection units to take away from players each tick.", " Applied even when players are in infectious biomes, so effectively subtracts 1 from the above number.", " Default: 1")
    ...
    public static final ModConfigSpec.IntValue FUNGAL_INFECTION_MINIMUM = BUILDER
        .comment(" Minimum value for infection buildup on a player.", " Default: 0")
    ...
    public static final ModConfigSpec.IntValue FUNGAL_INFECTION_MAXIMUM = BUILDER
        .comment(" Maximum value for infection buildup on a player.", " Default: " + Integer.MAX_VALUE)
