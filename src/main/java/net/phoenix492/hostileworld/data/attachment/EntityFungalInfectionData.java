package net.phoenix492.hostileworld.data.attachment;
...
public class EntityFungalInfectionData {
    ...
    public EntityFungalInfectionData tickScaledReduceInfectionLevel(long value) {
        this.infectionLevel -= value * HostileWorldConfig.SERVER_CONFIG.fungalInfectionPlayerTickFrequency.get();
        this.clampInfection();
        return this;
    }
    ...
    private void clampInfection() {
        this.infectionLevel = Math.clamp(this.infectionLevel, HostileWorldConfig.SERVER_CONFIG.fungalInfectionMinimum.get(), HostileWorldConfig.SERVER_CONFIG.fungalInfectionMaximum.get());
    }
}
